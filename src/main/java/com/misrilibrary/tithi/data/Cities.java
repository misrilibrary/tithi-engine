...
public class Cities {
    ...
    static {
        ...
        CITIES.put("Agra", new CityLocation(27.2, 78.0, 5.5));
        CITIES.put("Allahabad", new CityLocation(25.4, 81.8, 5.5));
        CITIES.put("Aurangabad", new CityLocation(19.9, 75.3, 5.5));
        CITIES.put("Bhubaneswar", new CityLocation(20.3, 85.8, 5.5));
        CITIES.put("Faridabad", new CityLocation(28.4, 77.3, 5.5));
        CITIES.put("Ghaziabad", new CityLocation(28.7, 77.4, 5.5));
        CITIES.put("Gorakhpur", new CityLocation(26.8, 83.4, 5.5));
        CITIES.put("Gwalior", new CityLocation(26.2, 78.2, 5.5));
        CITIES.put("Hubli", new CityLocation(15.4, 75.1, 5.5));
        CITIES.put("Jabalpur", new CityLocation(23.2, 79.9, 5.5));
        CITIES.put("Jalandhar", new CityLocation(31.3, 75.6, 5.5));
        CITIES.put("Jodhpur", new CityLocation(26.3, 73.0, 5.5));
        CITIES.put("Kanpur", new CityLocation(26.4, 80.3, 5.5));
        CITIES.put("Kota", new CityLocation(25.2, 75.9, 5.5));
        CITIES.put("Ludhiana", new CityLocation(30.9, 75.9, 5.5));
        CITIES.put("Madurai", new CityLocation(9.9, 78.1, 5.5));
        CITIES.put("Meerut", new CityLocation(29.0, 77.7, 5.5));
        CITIES.put("Nashik", new CityLocation(20.0, 73.8, 5.5));
        CITIES.put("Raipur", new CityLocation(21.3, 81.6, 5.5));
        CITIES.put("Rajkot", new CityLocation(22.3, 70.8, 5.5));
        CITIES.put("Ranchi", new CityLocation(23.3, 85.3, 5.5));
        CITIES.put("Salem", new CityLocation(11.7, 78.2, 5.5));
        CITIES.put("Surat", new CityLocation(21.2, 72.8, 5.5));
        CITIES.put("Thane", new CityLocation(19.2, 73.0, 5.5));
        CITIES.put("Tiruchirappalli", new CityLocation(10.8, 78.7, 5.5));
        CITIES.put("Tirupati", new CityLocation(13.6, 79.4, 5.5));
        CITIES.put("Udaipur", new CityLocation(24.6, 73.7, 5.5));
        CITIES.put("Vadodara", new CityLocation(22.3, 73.2, 5.5));
        CITIES.put("Vijayawada", new CityLocation(16.5, 80.6, 5.5));
        CITIES.put("Warangal", new CityLocation(18.0, 79.6, 5.5));
        CITIES.put("Mussoorie", new CityLocation(30.5, 78.1, 5.5));
        CITIES.put("Rishikesh", new CityLocation(30.1, 78.3, 5.5));
        CITIES.put("Haridwar", new CityLocation(29.9, 78.2, 5.5));
        CITIES.put("Mathura", new CityLocation(27.5, 77.7, 5.5));
        CITIES.put("Vrindavan", new CityLocation(27.6, 77.7, 5.5));
        CITIES.put("Ayodhya", new CityLocation(26.8, 82.2, 5.5));
        CITIES.put("Prayagraj", new CityLocation(25.4, 81.8, 5.5));
        CITIES.put("Dwarka", new CityLocation(22.2, 69.0, 5.5));
        CITIES.put("Shirdi", new CityLocation(19.8, 74.5, 5.5));
        CITIES.put("Moscow", new CityLocation(55.8, 37.6, 3.0));
        CITIES.put("Istanbul", new CityLocation(41.0, 29.0, 3.0));
        CITIES.put("Beijing", new CityLocation(39.9, 116.4, 8.0));
        CITIES.put("Shanghai", new CityLocation(31.2, 121.5, 8.0));
        CITIES.put("Osaka", new CityLocation(34.7, 135.5, 9.0));
        CITIES.put("Mexico City", new CityLocation(19.4, -99.1, -6.0));
        CITIES.put("Edinburgh", new CityLocation(55.9, -3.2, 0.0));
        CITIES.put("Manchester", new CityLocation(53.5, -2.2, 0.0));
        CITIES.put("Birmingham", new CityLocation(52.5, -1.9, 0.0));
    }
