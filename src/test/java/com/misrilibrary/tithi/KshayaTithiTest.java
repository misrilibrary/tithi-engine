...
class KshayaTithiTest {
    ...
    void chaitraS1_2026() {
        List<LocalDate> dates = panchang.getDates(LunarMonth.CHAITRA, Paksha.SHUKLA, 1, 2026, "Ujjain");
    ...
    void jyeshthaS1_2025() {
        List<LocalDate> dates = panchang.getDates(LunarMonth.JYESHTHA, Paksha.SHUKLA, 1, 2025, "Ujjain");
        assertFalse(dates.isEmpty(), "Kshaya tithi should still return a date");
    ...
    void kartikaK1_2025() {
        List<LocalDate> dates = panchang.getDates(LunarMonth.KARTIKA, Paksha.KRISHNA, 1, 2025, "Ujjain");
    ...
    void normalTithi() {
        List<LocalDate> dates = panchang.getDates(LunarMonth.CHAITRA, Paksha.SHUKLA, 5, 2026, "Ujjain");
        assertFalse(dates.isEmpty());
    }

    @Test @DisplayName("Vriddhi Margashirsha S1 2026 returns second day Dec 10")
    void vriddhiTithi() {
        List<LocalDate> dates = panchang.getDates(LunarMonth.MARGASHIRSHA, Paksha.SHUKLA, 1, 2026, "Ujjain");
