...
class TithiUtilsTest {
    ...
    void displayNameFormat() {
        ...
        TithiInfo info = panchang.tithiOnDate(LocalDate.of(2024, 6, 15), City.of("Ujjain"));
    ...
    void monthNeverBackward() {
        ...
        for (LocalDate d = LocalDate.of(2026, 1, 1); d.getYear() == 2026; d = d.plusDays(1)) {
            TithiInfo t = panchang.tithiOnDate(d, City.of("Ujjain"));
    ...
    void krishnaBeforeShukla() {
        ...
        TithiInfo early = panchang.tithiOnDate(LocalDate.of(2026, 1, 4), City.of("Ujjain"));
        ...
        TithiInfo later = panchang.tithiOnDate(LocalDate.of(2026, 1, 20), City.of("Ujjain"));
